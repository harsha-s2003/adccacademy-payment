...
<body class="body-bg" >
 <button type="button" onclick="printDiv('printableArea')" style="width:160px;float: right;" class="btn-primary">Print/Download Receipt</button>
...
<table width="100%" border="0" cellpadding="5" cellspacing="5">
  <tr>
    <td width="20%"><div align="left">Receipt No : </div></td>
  ...
  <tr>
    ...
    <td><span class="form-group mb-5">
     <?php if(empty($studentfeeD->pclass)) { ?>   
     <b><?= $school->class;?></b>
     <?php } else {?>
    <b><?= $studentfeeD->pclass;?></b>
    <?php } ?>
    </span></td>
  </tr>
  ...
  <tr>
    ...
    <td><span class="form-group mb-5">
     <?php if(empty($studentfeeD->psession)) { ?>    
     <b><?= $school->session;?></b>
      <?php } else {?>
    <b><?= $studentfeeD->psession;?></b>
    <?php } ?>
    </span></td>
  </tr>
