...
<body class="body-bg" >
 <input type="button" onclick="printDiv('printableArea')" value="Print/Download Invoice" style="width:160px;" />
...
<table width="100%" border="0" cellpadding="5" cellspacing="5">
  <tr>
    ...
    <td width="80%"><span class="form-group mb-5">
      <b><?= $installment_process->invoice_no;?></b>
    </span></td>
  </tr>
  ...
  <tr>
    ...
    <td><span class="form-group mb-5">
     <b><?= $mgs_employees->student_name;?></b>
    </span></td>
  </tr>
  ...
  <tr>
    ...
    <td><span class="form-group mb-5">
     <b><?= $mgs_employees->academic_year;?></b>
    </span></td>
  </tr>

  <tr>
    <td><div align="left"><span class="form-group mb-5">Installments </span></div></td>
    <td><span class="form-group mb-5">
     <b>
        <?php if($installment_process->inst1 != '0'){echo 'Installment-II';}?>
        <?php if($installment_process->inst2 != '0'){echo 'Installment-IV';}?>
     </b>
    </span></td>
  </tr>
   ...
   <tr>
    ...
    <td><span class="form-group mb-5">
      <b><?= date('d-m-Y',strtotime($installment_process->created));?></b>
    </span></td>
  </tr>
</table>
