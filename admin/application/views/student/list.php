          ...
          <div class="col-12">
            ...
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h3 class="card-title">Manage Student List</h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <!-- <td><?= $studentDataR->dob;?></td> -->
                    <!-- <td><?= $studentDataR->school_session;?></td> -->
                   <!--  <td><?= $studentDataR->email;?></td> -->
                    <td><?= $studentDataR->school;?></td>
                    <!-- <td><?= $studentDataR->show_password;?></td> -->
